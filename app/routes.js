...
export default [
  ...
  layout('routes/api/admin/v1/_layout.jsx', [
    ...prefix('api/admin/v1', [
      ...
      route(
        ...
        'routes/api/admin/v1/back-in-stock-subscriptions.jsx'
      ),
  ...
  ...prefix('admin', [
    ...
    layout('routes/admin/_layout.jsx', [
      ...
      route('security', 'routes/admin/security.jsx'),
      ...
      route('categories/:id', 'routes/admin/categories/$id.jsx'),
      // Content (W5)
      ...
      route('discounts/:id', 'routes/admin/discounts/$id.jsx'),
      ...
      route('customer-groups/:id', 'routes/admin/customer-groups/$id.jsx'),
      route('price-lists', 'routes/admin/price-lists/index.jsx'),
      route('price-lists/new', 'routes/admin/price-lists/new.jsx'),
      route('price-lists/:id', 'routes/admin/price-lists/$id.jsx'),
      ...
      route('subscriptions/new', 'routes/admin/subscriptions/new.jsx'),
      route('subscriptions/:id', 'routes/admin/subscriptions/$id.jsx'),
      route('pos', 'routes/admin/pos/index.jsx'),
      route('companies', 'routes/admin/companies/index.jsx'),
      route('companies/new', 'routes/admin/companies/new.jsx'),
      route('companies/:id', 'routes/admin/companies/$id.jsx'),
      route('quotes', 'routes/admin/quotes/index.jsx'),
      route('quotes/new', 'routes/admin/quotes/new.jsx'),
      route('quotes/:id', 'routes/admin/quotes/$id.jsx'),
      ...
      route('channels/:id', 'routes/admin/channels/$id.jsx'),
      // Themes (P5-8)
