      ...
      <div className="space-y-12">
          ...
          <Form method="post">
            ...
            <div className="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              <Field
                ...
                label={t('admin.customers.detail.name')}
              ...
              <Field
                className="sm:col-span-3"
                label={t('admin.customers.detail.phone')}
              ...
              <Field
                className="sm:col-span-3"
                label={t('admin.customers.detail.preferredLocale')}
                htmlFor="customer-locale"
              >
                <Input
                  id="customer-locale"
                  type="text"
              ...
              <Field
                ...
                htmlFor="customer-email-readonly"
              >
                <p
                  id="customer-email-readonly"
                  className="bg-surface-2 border-border text-text-muted rounded-md border px-3 py-1.5 text-sm"
                >
                  {customer.email}
                </p>
              </Field>
        ...
        >
          ...
          {!customer.erasedAt ? (
            <Form
              method="post"
              className="mb-6 grid max-w-2xl gap-4 sm:grid-cols-[1fr_2fr_auto]"
            >
