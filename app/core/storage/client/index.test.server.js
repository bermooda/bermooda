...
describe('getObjectUrl', () => {
  it('uses STORAGE_PUBLIC_URL when set', async () => {
    ...
    const { getObjectUrl } = await import('#/core/storage/client/index.server');
...
describe('putObject', () => {
  it('throws Storage not configured error when env vars are missing', async () => {
    ...
    const { putObject } = await import('#/core/storage/client/index.server');
...
describe('deleteObject', () => {
  it('throws Storage not configured error when env vars are missing', async () => {
    ...
    const { deleteObject } = await import('#/core/storage/client/index.server');
